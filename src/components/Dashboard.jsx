            ...
            {lists.length === 0 ? (
                ...
                <div className="empty-state">
                    <div className="empty-illustration">
                        ...
                        <svg width="180" height="180" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M92 120H108M100 112V128" stroke="#F4EBFF" strokeWidth="3" strokeLinecap="round" />
                        </svg>
                    </div>
                    ...
                    <div className="arrow-pointer">
                        <svg width="80" height="80" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M20 20C40 50 50 70 80 80" stroke="#7F56D9" strokeWidth="2" strokeDasharray="5 5" strokeLinecap="round" />
                            <path d="M80 80L70 72M80 80L75 90" stroke="#7F56D9" strokeWidth="2" strokeLinecap="round" />
                        </svg>
                    </div>
                </div>
            ) : (
                ...
                <div className="lists-stack">
                    {lists.map((list) => {
                        ...
                        return ( // Geriye bir kart ve kartın içinde listenin bilgilerini döndürüyoruz.
                                ...
                                <div className="card-top">
                                    <div className="card-info">
                                        ...
                                        <div className="collaborators">
                                            {list.sharedWith.map((user, idx) => { // Eğer liste biriyle paylaşıldıysa o kullanıcının ismini alıyoruz ve istediğimiz formata getiriyoruz.
                                                const initials = user.name
                                                    ? user.name.split(' ').map(w => w[0]).join('').toUpperCase().slice(0, 2)
                                                    : '?';
                                                return ( // Geriye ise kullanıcının avatarını döndürüp ekrana yazdırıyoruz
                                                    <div
                                                        key={idx}
                                    ...
                                    <button className="favorite-btn" onClick={(e) => { e.stopPropagation(); onToggleDraft(list.id); }} aria-label="Add to favorites">
                                        <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" fill={list.isDraft ? "#FFD700" : "currentColor"}>
