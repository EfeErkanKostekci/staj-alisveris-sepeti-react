      ...
      if (res.ok) {
        ...
        const mapped = responseJson.data.map((share) => ({
          ...
          avatar: share.profilePictureUrl
            ...
            : `https://api.dicebear.com/7.x/notionists/svg?seed=${share.inviteeEmail}`,
        }));
            ...
            {sendMsg && (
              <p
                style={{
                  ...
                  marginTop: '8px',
                  padding: '0 2px',
                  color: sendMsg.startsWith('✅') ? '#12b76a' : '#f04438',
                }}
              >
                {sendMsg}
              </p>
                ...
                <div className="user-left">
                  ...
                  <div className="invite-user-details">
                    <span className="invite-user-name">
                      {user.name}
                      {user.status === 'Pending' && (
                        <span style={{ fontSize: '10px', color: '#f79009', marginLeft: '6px' }}>
                          (Pending)
                        </span>
                      )}
                    </span>
  ...
  return (
    <div className="dropdown-backdrop" onClick={onClose}>
      <div className="options-dropdown-card" onClick={(e) => e.stopPropagation()}>
        ...
        {isOwner && (
          <button
            className="dropdown-option-btn delete-option"
            onClick={() => {
              onDeleteList();
              onClose();
            }}
